...
def assert_string_arrays_equal( expected, actual, msg):
...
def assert_string_arrays_equal_wildcards( expected, actual, msg):
...
def match_array( pattern, target):
...
def num_skipped_prefix_lines( a1, a2):
    num_eq = 0
...
def num_skipped_suffix_lines( a1, a2):
    num_eq = 0
